...
This script performs a comprehensive analysis of agricultural yield data across different Agro-Ecological Zones (AEZs) in Africa using the *tidymodels* framework and implementing bootstrap resampling to quantify uncertainty in predictions and feature importance.
